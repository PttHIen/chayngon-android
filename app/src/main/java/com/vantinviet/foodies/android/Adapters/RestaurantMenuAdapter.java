...
import com.vantinviet.foodies.android.ActivitiesAndFragments.RestaurantMenuItemsFragment;
...
//      this.count=ListChildTerbaru.size();
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (get_order_status.equalsIgnoreCase("1")) {
            ...
            int tien = Integer.parseInt(childTerbaru.getPrice());
            String pattern = "###,###,###.###";
            DecimalFormat decimalFormat = new DecimalFormat(pattern);

            String format = decimalFormat.format(tien);
            holder.price_tv.setText(format + " " + get_symbol);
        ...
        Picasso.with(context).load(Config.imgBaseURL + childTerbaru.getImagePath().toString()).
                fit().centerCrop()
                .placeholder(R.drawable.app_icon)
                .error(R.drawable.app_icon).into(holder.image_child);
