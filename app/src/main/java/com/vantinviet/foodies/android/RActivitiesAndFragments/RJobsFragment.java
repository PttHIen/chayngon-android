...
import com.vantinviet.foodies.android.RActivitiesAndFragments.RAdapters.RCurrentJobAdapter;
import com.vantinviet.foodies.android.RActivitiesAndFragments.RAdapters.RPendingJobAdapter;
import com.vantinviet.foodies.android.RActivitiesAndFragments.RiderModels.ROrderModel;
...
public class RJobsFragment extends Fragment implements GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks {
    ...
    public void getCurrentOrderList(){
       ...
       RequestQueue queue = Volley.newRequestQueue(getContext());
        ...
        Log.d("jsonObjectrider", jsonObject.toString());
                    ...
                    if(code_id!=200){
                        ...
                        for (int i = 0; i < jsonarray.length(); i++) {
                          ...
                          //  JSONObject jsonObjTax = json1.getJSONObject("Tax");
                            ...
                            String street = restaurantLocObj.optString("street");


                            riderJobModel.setHotel_address(zip+", "+street);
                            ...
                            Log.d("riderJobModel", riderJobList.toString());
                ...
                new FirebaseRecyclerAdapter<ROrderModel, RJobsFragment.Orderviewholder>(options)
                {
                    ...
                    protected void onBindViewHolder(RJobsFragment.Orderviewholder holder, int position, final ROrderModel model) {
                        ...
                        //   initViewMenuOrderExtraItem(view,false);
                            ...
                            holder.r_total_bil_tv.setText(model.getPrice() + " "+ model.getSymbol());
                            holder.accept_btn.setVisibility(View.GONE);
                ...
                try {
                    ...
                    if(code_id!=200){
                        ...
                        for (int i = 0; i < jsonarray.length(); i++) {
                            ...
                            riderJobModel.setOrder_delivery_fee(restaurantObj.optString("delivery_fee_range"));


                            riderJobModel.setHotel_zip(restaurantLocObj.optString("zip"));

                            riderJobModel.setHotel_state(restaurantLocObj.optString("street"));
