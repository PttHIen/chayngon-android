...
import com.vantinviet.foodies.android.ActivitiesAndFragments.PagerMainActivity;
...
public class ROrderDetailFragment extends Fragment {
    ...
    public void init(View v){
      ...
      String order_time = rDetail_Pref.getString(PreferenceClass.RIDER_TIME,"");
        ...
        r_total_bil_tv.setText(sub_total+symbol);
    ...
    public void showRiderTracking(){
        ...
        try {
            ...
            Log.d("ádasfas1", "showRiderTracking: ");
        } catch (JSONException e) {
            Log.d("ádasfas", "showRiderTracking: ");
        }
        Log.d("tôi đến nha hàng", jsonObject.toString());
        JsonObjectRequest trackingRequest = new JsonObjectRequest(Request.Method.POST, Config.SHOW_RIDER_TRACKING, jsonObject, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                Log.d("TRACKING_POST", response.toString());
    ...
    public void trackRiderStatus(){
        ...
        Log.d("TRACK_JSONPost", jsonObject.toString());
        Log.d("TRACK_RIDER_STATUS", Config.TRACK_RIDER_STATUS);
