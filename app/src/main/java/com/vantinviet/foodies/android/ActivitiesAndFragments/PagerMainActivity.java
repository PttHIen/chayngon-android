...
import com.vantinviet.foodies.android.Adapters.AdapterPager;
import com.vantinviet.foodies.android.Constants.PreferenceClass;
import com.vantinviet.foodies.android.R;
import com.vantinviet.foodies.android.Utils.CustomViewPager;
import com.vantinviet.foodies.android.Utils.SwipeDirection;
...
public class PagerMainActivity extends Fragment {
    ...
    private int[] tabIcons1 = {R.drawable.res_not_filled, R.drawable.deals_not_filled,
            R.drawable.order_not_filled, R.drawable.basket_not_filled, R.drawable.account_not_filled};

    private int[] tabIcons = {R.drawable.res_filled, R.drawable.deals_filled,
            R.drawable.order_filled, R.drawable.basket_filled, R.drawable.account_filled};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setIcon(R.drawable.res_not_filled));
        tabLayout.addTab(tabLayout.newTab().setIcon(R.drawable.deals_not_filled));
        tabLayout.addTab(tabLayout.newTab().setIcon(R.drawable.order_not_filled));
        tabLayout.addTab(tabLayout.newTab().setIcon(R.drawable.basket_not_filled));
        tabLayout.addTab(tabLayout.newTab().setIcon(R.drawable.account_not_filled));
        ...
        if (tabLayout != null) {
            ...
            if (MainActivity.FLAG_MAIN) {
                ...
                for (int i = 1; i < tabIcons1.length; i++) {
                    tabLayout.getTabAt(0).setIcon(R.drawable.res_filled);
