...
import com.vantinviet.foodies.android.Adapters.ShowReviewListAdapter;
...
import com.vantinviet.foodies.android.Models.RatingListModel;
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, REVIEW_API, jsonObject, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    Log.d("JSONPostReveiw", jsonResponse.toString());
                    ...
                    if (code_id == 200) {
                        ...
                        Toast.makeText(getContext(), "Hiện tại nhà hàng  không có lượt đánh giá nào!", Toast.LENGTH_SHORT).show();
                        TabLayoutUtils.enableTabs(PagerMainActivity.tabLayout,true);
                        transparent_layer.setVisibility(View.GONE);
                        progressDialog.setVisibility(View.GONE);
