    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        try{String finalExpiryDate = expiry_date.substring(0,10);
            ...
            e.getCause();
                ...
                holder.per_km_deal_tv.setText(getDataAdapter1.getDeal_delivery_fee()+ getDataAdapter1.getDeal_symbol()+ "/km");
                holder.deal_name.setText(getDataAdapter1.getDeal_name());
                holder.restaurant_name.setText(getDataAdapter1.getRestaurant_name());
                holder.deal_price.setText(getDataAdapter1.getDeal_price()+ " " +getDataAdapter1.getDeal_symbol());
