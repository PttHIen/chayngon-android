...
import com.vantinviet.foodies.android.Adapters.AddressListAdapter;
import com.vantinviet.foodies.android.Constants.Config;
import com.vantinviet.foodies.android.Constants.PreferenceClass;
import com.vantinviet.foodies.android.Models.AddressListModel;
 ...
 */
    ...
    Fragment addressDetailFragment = new AddressDetailFragment();
    ...
    public void initUI(View v){
        ...
        add_address_div.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                transaction.add(R.id.address_list_container, addressDetailFragment,"parent").commit();
    ...
    public void getAddressList(){
        ...
        Log.d("jsonObject API",Config.GET_DELIVERY_ADDRESES);
        Log.d("jsonObject", addressJsonObject.toString());
                            ...
                            if(code_id == 200) {
                                ...
                                for (int i=0;i<jsonarray.length();i++){
                                    ...
                                    if(jsonObjAdd.optString("lat").isEmpty()){
                                        addressListModel.setLat("");
                                    }
                                    else {
                                        addressListModel.setLat(jsonObjAdd.optString("lat"));
                                    }
                                    if(jsonObjAdd.optString("long").isEmpty()){
                                        addressListModel.setLong("");
                                    }
                                    else {
                                        addressListModel.setLong(jsonObjAdd.optString("long"));
                                    }
                                ...
                                if(arrayListAddress != null) {
                                    ...
                                    recyclerViewadapter.setOnItemClickListner(new AddressListAdapter.OnItemClickListner() {
                                        ...
                                        public void OnItemClicked(View view, int position) {
                                            ...
                                            editor.putString(PreferenceClass.LAT_SHIP,arrayListAddress.get(position).getLat());
                                            editor.putString(PreferenceClass.LONG_SHIP,arrayListAddress.get(position).getLong());
