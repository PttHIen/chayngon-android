package com.vantinviet.foodies.android.GoogleMapWork;
...
public class SearchPlaces extends AppCompatActivity implements PlaceAutocompleteAdapter.PlaceAutoCompleteInterface, GoogleApiClient.OnConnectionFailedListener,
  ...
  //  PlaceSavedAdapter mSavedAdapter;
    ...
    public void getLatlngBounds(){
        String lat = placePref.getString(PreferenceClass.LATITUDE, "");
        String lon = placePref.getString(PreferenceClass.LONGITUDE, "");

        String finalCityName = city_name.replaceAll(" ","%20");
        RequestQueue requestQueue = Volley.newRequestQueue(SearchPlaces.this);
        String url=Config.GET_CITY_BOUNDRIES+"?key="+getResources().getString(R.string.google_map_api_key)+"&type=restaurant&radius=1500&location="+lat+","+lon;
        Log.d("GET_CITY_BOUNDRIES",url);
                    ...
                    for (int i =0;i<jsonArray.length();i++) {
                        ...
                        try {
                            ...
                            PendingResult<AutocompletePredictionBuffer> results =
                                    Places.GeoDataApi.getAutocompletePredictions(mGoogleApiClient, "Starbucks", BOUNDS_PAKISTAN, null);
                        } catch (Exception e){
                            e.getCause();
                        }
                ...
                placeResult.setResultCallback(new ResultCallback<PlaceBuffer>() {
                    ...
                    public void onResult(PlaceBuffer places) {
                        if(places.getCount()==1){
                            ...
                            Log.e("Latiturekdjkjdf",String.valueOf(places.get(0).getLatLng().latitude));
