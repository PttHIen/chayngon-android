...
import com.vantinviet.foodies.android.HActivitiesAndFragment.HAdapter.HAdapter;
...
public class HPagerMainFragment extends Fragment {
    ...
    private int[] tabIcons1 = {R.drawable.r_job_not_filled,R.drawable.order_not_filled,
            R.drawable.r_profile_not_filled};

    private int[] tabIcons = {R.drawable.r_job_filled,R.drawable.order_filled,
            R.drawable.r_profile_filled};
