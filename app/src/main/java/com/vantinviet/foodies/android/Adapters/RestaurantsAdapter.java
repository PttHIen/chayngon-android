...
import com.vantinviet.foodies.android.ActivitiesAndFragments.ShowFavoriteRestFragment;
...
public class RestaurantsAdapter extends RecyclerView.Adapter<RestaurantsAdapter.ViewHolder> implements Filterable {
    ...
    public RestaurantsAdapter(ArrayList<RestaurantsModel> listRestaurantsModel, Context context,ShowFavoriteRestFragment fragment,CamomileSpinner progressBar){
        super();
        this.listRestaurantsModel = listRestaurantsModel;
        mFilteredList = listRestaurantsModel;
...
//        imageLoader1.get(getDataAdapter1.getRestaurant_image(),
      ...
      //  holder.item_price_per_mile.setText(symbol+" "+getDataAdapter1.getDelivery_fee_per_km()+" / over"+" "+symbol+" "+getDataAdapter1.getMin_order_price());
        ...
        holder.item_time_tv.setText(getDataAdapter1.getDelivery_fee_per_km()+ " "+ symbol+ " / over"+getDataAdapter1.getMin_order_price() +" "+symbol);
        ...
        holder.restaurant_row_main.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (onItemClickListner !=null){
                    ...
                    for (int i = 0; i < listRestaurantsModel.size() ; i++ ){
                        if(name.equals(listRestaurantsModel.get(i).getRestaurant_id())){
                            position = i;
                            break;
                        }
                    }
