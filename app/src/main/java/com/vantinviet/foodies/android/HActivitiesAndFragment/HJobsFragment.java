package com.vantinviet.foodies.android.HActivitiesAndFragment;
...
import com.vantinviet.foodies.android.ActivitiesAndFragments.OrderDetailFragment;
import com.vantinviet.foodies.android.Adapters.OrderAdapter;
...
import com.vantinviet.foodies.android.Models.OrderModelClass;
...
public class HJobsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        order_tv.setText("Đơn hàng hiện tại");
        getAllOrderParser();
  ...
  orderProgressBar.setVisibility(View.VISIBLE);
        ...
        String latitude = sPre.getString(PreferenceClass.LATITUDE,"");
        String longitude = sPre.getString(PreferenceClass.LONGITUDE,"");
                        ...
                        try {
                            ...
                            if (code_id == 200) {
                                ...
                                for (int i = 0; i < jsonarray.length(); i++) {
                                    ...
                                    if (jsonObjOrder.getJSONArray("OrderMenuItem") != null) {
                                        ...
                                        for (int j = 0; j < jsonarrayOrder.length(); j++) {
                                            JSONObject jsonObjectMenu = jsonarrayOrder.getJSONObject(j);
                                            JSONArray jsonarrayExtraOrder = jsonObjectMenu.getJSONArray("OrderMenuExtraItem");


                                            if (jsonarrayExtraOrder.length() != 0) {
                                                for (int m = 0; m < jsonarrayExtraOrder.length(); m++) {
                                                    JSONObject jsonObjectExtraMenu = jsonarrayExtraOrder.getJSONObject(m);
                                ...
                                if (orderArrayList != null) {
                                   ...
                                   order_list.setAdapter(recyclerViewadapter);
...
// Add the request to the RequestQueue.
    ...
    public void customDialogbox(){
        ...
        dialog.setTitle("Bộ lọc đặt hàng");
        ...
        textView1.setText("Đơn hàng hiện tại");
        TextView textView2 = (TextView)dialog.findViewById(R.id.second_tv);
        textView2.setText("Cấp phát đơn đặt hàng");
        ...
        pastOrderDiv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               getAllPendingOrderParser();
                ACCEPTED_ORDER = true;
                order_tv.setText("Danh sách hàng chờ");
                dialog.dismiss();
            }
        });
