...
public class RiderJobModel {
    ...
    public void setHotel_name(String order_name) {
        this.hotel_name = order_name;
    }
    ...
    public String getOrder_cash_status() {
        return order_cash_status;
    }

    public void setOrder_cash_status(String order_cash_status) {
        this.order_cash_status = order_cash_status;
    }
    ...
    public void setRider_symbol(String rider_symbol) {
        this.rider_symbol = rider_symbol;
    }
