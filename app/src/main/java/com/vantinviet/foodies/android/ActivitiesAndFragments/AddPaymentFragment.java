...
import com.vantinviet.foodies.android.Adapters.CreditCardDetailAdapter;
import com.vantinviet.foodies.android.Constants.Config;
import com.vantinviet.foodies.android.Constants.PreferenceClass;
import com.vantinviet.foodies.android.Models.CardDetailModel;
...
public class AddPaymentFragment extends Fragment {
    ...
    RelativeLayout add_payment_method_div,cash_on_delivery_div, payment_by_momo_div;
    ImageView back_icon;
    public static boolean FLAG_FRAGMENT,FLAG_PAYMENT_METHOD,FLAG_CASH_ON_DELIVERY,FLAG_ADD_PAYMENT,FLAG_PAYMENT_BY_MOMO;
    ...
    public void initUI(View v){
        ...
        payment_by_momo_div = v.findViewById(R.id.payment_by_momo_div);
      ...
      /*  if(AddPaymentDetailFragment.cardetailArraylist!=null) {
            restaurantsHomePageAdapter = new CreditCardDetailAdapter(AddPaymentDetailFragment.cardetailArraylist, getActivity());
            card_recycler_view.setAdapter(restaurantsHomePageAdapter);
...
*/
        ...
        if(DealOrderFragment.DEAL_PAYMENT_METHOD||CartFragment.CART_PAYMENT_METHOD){
            ...
            payment_by_momo_div.setVisibility(View.VISIBLE);
          ...
          //  DealsDetailFragment.FLAG_DEALS_DETAIL_FRAGMENT=true;
            ...
            payment_by_momo_div.setVisibility(View.GONE);
        }
        ...
        payment_by_momo_div.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(CartFragment.CART_PAYMENT_METHOD){
                    CartFragment userAccountFragment = new CartFragment();
    ...
    public void getPaymentList()  {
        ...
        Log.d("paymentJsonObject",paymentJsonObject.toString());
        Log.d("GET_PAYMENT_METHID_LINK",Config.GET_PAYMENT_METHID);
        JsonObjectRequest payJsonObjectRequest = new JsonObjectRequest(Request.Method.POST, Config.GET_PAYMENT_METHID, paymentJsonObject, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                VolleyLog.d("JSONPOSTGETPAYMENT ERROR %s", error.getMessage());
