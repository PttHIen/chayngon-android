...
public class RWeeklyEarningFragment extends Fragment {
    ...
    public void callWebView(View v) {
        ...
        if(HProfileFragment.FLAG_ADMIN){
            mWebview.loadUrl("http://dinosoftlabs.com/foodies/restaurants/login.php?device=app");

        }
        else {
            mWebview.loadUrl("http://dinosoftlabs.com/foodies/courier/login.php?device=app");
        }
